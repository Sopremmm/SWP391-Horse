...
const defaultNavLinks: SpectatorNavLink[] = [
  ...
  { label: 'Profile', href: '/Spectator/Profile' },
];
...
function SpectatorProfileMenu() {
  ...
  return <div className="spectator-header__profile" onBlur={handleBlur}>
    ...
    {open ? <div className="spectator-header__menu" role="menu"><Link to="/Spectator/Profile" role="menuitem" onClick={close}>Profile</Link><button type="button" role="menuitem" onClick={() => { close(); navigate('/'); }}>Logout</button></div> : null}
  </div>;
}
