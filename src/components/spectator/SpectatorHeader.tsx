    ...
    <header className="spectator-header">
      <div className="spectator-header__inner">
        ...
        <div className="spectator-header__actions">
          {showFunds && (
            <div className="spectator-header__funds" aria-label="Available funds">
              <span>Available funds</span>
              <strong>$2,450.00</strong>
            </div>
          )}
          {showNotifications && (
            <button className="spectator-header__icon-button" aria-label="Notifications">
          ...
          <button className="spectator-header__profile-button" aria-label="Profile">
            <svg width="26" height="26" viewBox="0 0 26 26" fill="none" aria-hidden="true">
              <path
                d="M13 13C14.35 13 15.5 12.53 16.45 11.58C17.4 10.63 17.88 9.48 17.88 8.12C17.88 6.77 17.4 5.62 16.45 4.67C15.5 3.72 14.35 3.25 13 3.25C11.65 3.25 10.5 3.72 9.55 4.67C8.6 5.62 8.12 6.77 8.12 8.12C8.12 9.48 8.6 10.63 9.55 11.58C10.5 12.53 11.65 13 13 13ZM4.02 22.75C5.05 21.14 6.36 19.9 7.94 19.01C9.52 18.13 11.21 17.69 13 17.69C14.79 17.69 16.48 18.13 18.06 19.01C19.64 19.9 20.95 21.14 21.98 22.75C19.53 25 16.54 26 13 26C9.46 26 6.47 25 4.02 22.75Z"
                fill="currentColor"
              />
            </svg>
          </button>
