...
export const SpectatorRaceDetail: React.FC = () => {
        ...
        <section className="spectator-race-hero">
          <div className="spectator-race-hero__inner">
            <div className="spectator-race-hero__copy">
              ...
              <p>
                The pinnacle of equestrian endurance and speed. Established in 1924, this race remains the definitive test
                for world-class thoroughbreds.
              </p>
            </div>
