...
public class User {
    ...
    public User(String email, String password, String fullName, String phone, Role role, UserStatus status) {
        this.email = email;
    ...
    public static class UserBuilder {
        ...
        public User build() {
            return new User(email, password, fullName, phone, role, status);
        }
    }
